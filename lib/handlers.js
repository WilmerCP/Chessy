...
//Player queue for random matchmaking
...
//Serving mp3 sound effects
handlers.sound = function(datos,callback){

    let filename = datos.url.pathname.replace('/public/sound/','');
